        ...
        watch: {
            hoveringDate(date) {
                if (this.checkIn !== null  && this.checkOut == null && this.isDisabled == false) {
                    if (
                        this.isDateLessOrEquals(this.checkIn, this.date) && this.isDateLessOrEquals(this.date, this.hoveringDate) ||
                        this.isDateLessOrEquals(this.hoveringDate, this.date) &&
                        this.isDateLessOrEquals(this.date, this.checkIn) && this.isDateLessOrEquals(Date.now(), this.hoveringDate)
                    ) {
